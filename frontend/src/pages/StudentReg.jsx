    ...
    <>
      <div className="container mx-auto py-16 font-outfit">
        ...
        >
          ...
          <div className="flex flex-col">
            <label htmlFor="graduationYear" className="text-gray-600 mb-2">
              Graduation Year
            </label>
            <select
              id="graduationYear"
          ...
          <div className="flex flex-col">
            <label htmlFor="collegeEmail" className="text-gray-600 mb-2">
          ...
          <div className="flex flex-col">
            <label htmlFor="course" className="text-gray-600 mb-2">
              Course
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col">
            <label htmlFor="linkedin" className="text-gray-600 mb-2">
              LinkedIn
            </label>
            <input
              type="url"
          ...
          <div className="flex flex-col">
            <label htmlFor="github" className="text-gray-600 mb-2">
              GitHub
            </label>
            <input
              type="url"
          ...
          <div className="flex flex-col">
            <label htmlFor="profilePhoto" className="text-gray-600 mb-2">
              Profile Photo
            </label>
            <input
              type="file"
          ...
          <div className="col-span-1 md:col-span-2 flex justify-center">
            <button
              type="submit"
              className="bg-primary font-outfit text-white px-10 py-3 rounded-full font-light hover:bg-orange-600 transition"
            >
              Create Account
            </button>
          </div>
