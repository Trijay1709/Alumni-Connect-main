  ...
  return (
    <div className="container mx-auto py-16 font-outfit">
      ...
      >
        ...
        {/* Degree Certificate */}
        <div className="flex flex-col">
          <label htmlFor="degreeCertificate" className="text-gray-600 mb-2">
            Degree Certificate
          </label>
          <input
            type="url"
        ...
        <div className="col-span-2 flex justify-center">
          <button
            type="submit"
            className="bg-primary text-white px-10 py-3 rounded-full font-light hover:bg-orange-600 transition"
          >
            Create Account
          </button>
        </div>
